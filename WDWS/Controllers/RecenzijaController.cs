...
namespace WDWS.Controllers
{
    public class RecenzijaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,tekstRecenzije,putovanjeID,clientID")] Recenzija recenzija)
        {
            ...
            ViewData["putovanjeID"] = new SelectList(_context.Putovanja, "putID", "putID", recenzija.putovanjeID);
            return View(recenzija);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,tekstRecenzije,putovanjeID,clientID")] Recenzija recenzija)
        {
            if (id != recenzija.ID)
            {
                return NotFound();
