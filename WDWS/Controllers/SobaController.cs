...
namespace WDWS.Controllers
{
    public class SobaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,tipSobe,kapacitetSobe,cijena,smjestajID")] Soba soba)
        {
            ...
            ViewData["smjestajID"] = new SelectList(_context.Smjestaji, "ID", "ID", soba.smjestajID);
            return View(soba);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,tipSobe,kapacitetSobe,cijena,smjestajID")] Soba soba)
        {
            if (id != soba.ID)
            {
                return NotFound();
