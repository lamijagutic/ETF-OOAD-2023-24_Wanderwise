...
namespace WDWS.Controllers
{
    public class PutovanjeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,duzinaPutovanja,datumPolaska,datumDolaska,cijenaPoOsobi,prijevoznaSredstva,smjestajID")] Putovanje putovanje)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,duzinaPutovanja,datumPolaska,datumDolaska,cijenaPoOsobi,prijevoznaSredstva,smjestajID")] Putovanje putovanje)
        {
            if (id != putovanje.ID)
            {
                return NotFound();
